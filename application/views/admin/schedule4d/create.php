              ...
              <form action="<?php echo site_url('schedule3d/save/') ?>" method="post"  enctype="multipart/form-data">
                ...
                <div class="form-group">                        
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="day4" class="form-control" id="exampleInputEmail1" >
                  </div>
                  <div class="form-group">
                    <label for="exampleInputEmail1">Activity 4</label>
                    <input type="text" name="activity4" class="form-control" id="exampleInputEmail1" >
                  </div>
                </div>
                <!-- /.card-body -->
